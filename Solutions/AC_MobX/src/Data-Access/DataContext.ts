...
//
// Supplies asynchronous operations to connect to the web service and retrieve data.
// Pay attention to the getBeveragesSlow and getPastriesSlow methods. The database
// URIs for these two operations are delayed by ten seconds, which allows for testing
// changing the view while an asynchronous operation is in progress.
//
